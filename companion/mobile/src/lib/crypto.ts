/**
 * Crypto abstraction layer for the Burner Wallet mobile companion.
 *
 * Uses JS implementations (bip39, @scure/bip32, @noble/hashes) for now.
 * Will be swapped to the companion-core JSI bridge when available.
 */
